...
import { getAllfavorites, getMediaSearchResults } from "@/utils";
...
export default function Search() {
  ...
  useEffect(() => {
    async function getSearchResults() {
      const tvShows = await getMediaSearchResults("tv", params.query);
      const movies = await getMediaSearchResults("movie", params.query);
